...
$minPrice = isset($_GET['min_price']) && $_GET['min_price'] !== ''
    ? filter_input(INPUT_GET, 'min_price', FILTER_VALIDATE_FLOAT)
    : null;

$maxPrice = isset($_GET['max_price']) && $_GET['max_price'] !== ''
    ? filter_input(INPUT_GET, 'max_price', FILTER_VALIDATE_FLOAT)
    : null;
...
/*
 * InfinityFree does not allow CREATE VIEW for this account.
 * Therefore, instead of using vw_product_feed,
 * we directly join the required tables here.
 */
$sql = "SELECT
            p.product_id,
            p.title,
  ...
  <div class="row g-3">
    ...
    <div class="col-12 col-lg-9 col-xl-10">
        ...
        <form method="GET"
          ...
          <div class="col-12 col-md-4">
            ...
            <input
              ...
              id="q"
              name="q"
              value="<?php echo sanitize($keyword); ?>"
              placeholder="Book, laptop..."
            >
            ...
            >
              ...
              <?php foreach (getCategories($conn) as $cat): ?>
                ...
                <option
                  ...
                  <?php echo $category === $name ? 'selected' : ''; ?>
                >
      ...
      <p class="text-muted small mb-3">
        ...
        product<?php echo $resultCount === 1 ? '' : 's'; ?>
        ...
        <?php if ($keyword !== ''): ?>
          ...
          for
          "<strong><?php echo sanitize($keyword); ?></strong>"
